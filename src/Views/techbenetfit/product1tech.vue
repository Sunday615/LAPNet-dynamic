...
const cards = [
  {
    ...
    text: 'ປະຢັດເວລາ, ສະດວກ ໂດຍລູກຄ້າບໍ່ຕ້ອງລໍຖ້າການໃຊ້ບໍລິການ ຫຼື ຊອກຫາຕູ້ເອທີເອັມຂອງ ທະນາຄານຜູ້ອອກບັດ ກໍ່ສາມາດກວດຍອດເງິນຜ່ານຕູ້ເອທີເອັມຂອງບັນດາ ທະນາຄານທຸກລະກິດທີ່ເຊື່ອມຕໍ່ກັบລະບົບແລັບ.',
  },
  {
    icon: 'fa-solid fa-circle-exclamation',
    title: 'ເງື່ອນໄຂການໃຊ້ບໍລິການ',
    text: 'ລູກຄ້າທີ່ມີບັດເອທີເອັມຂອງທະນາຄານທີ່ເປັນສະມາຊິກຂອງ ແລັບເນັດ, ໂດຍສາມາດສັງເກດໄດ້ຈາກ ສັນຍາລັກແລັບເນັດທີ່ ຕິດຕາມຕູ້ເອທີເອັມ ກໍສາມາດໃຊ້ຮ່ວມກັນໄດ້. ເຊິ່ງການກວດຍອດເງິນຂ້າມຕູ້ເອທີເອັມນີ້ແມ່ນບໍ່ເສຍຄ່າທຳນຽມໃດໆທັງນັ້ນ.',
  },
