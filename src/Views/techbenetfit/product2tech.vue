...
const cards = [
  {
    ...
    text: 'ປະຢັດຄ່າໃຊ້ຈ່າຍໃນການລົງທຶນເຊັ່ນ: ຫຼຸດຜ່ອນຄ່າໃຊ້ຈ່າຍໃນການຂະຫຍາຍຕູ້ ATM ແລະ ຄ່ານໍາລຸງຮັກສາທີ່ຕິດພັນກັບການ ຂະຫຍາຍ ຕູ້ ATM; ເພີ່ມຈຸດບໍລິການຕູ້ ATM ແກ່ລູກຄ້າຂອງທະນາຄານທີ່ເຂົ້າເປັນສະມາຊິກ ຊຶ່ງສາມາດບໍລິການລູກຄ້າໄດ້ທົ່ວປະເທດ ດ້ວຍຄ່າໃຊ້ ຈ່າຍໃນການລົງທຶນຕໍ່າ.',
  },
  {
    icon: 'fa-solid fa-user',
    title: 'ດ້ານລູກຄ້າຂອງທະນາຄານ',
    text: 'ລູກຄ້າສາມາດນໍາໃຊ້ຕູ້ ATM ຂອງທຸກທະນາຄານທີ່ເປັນສະມາຊິກ ຂອງລະບົບ LAPS ຊຶ່ງປັດຈຸບັນມີທະນາຄານສະມາຊິກທັງໝົດ 16 ທະນາຄານ ເປັນການອໍານວຍຄວາມສະດວກ ແລະ ປະຢັດເວລາ ໂດຍລູກຄ້າບໍ່ຈໍາເປັນຕ້ອງລໍຖ້າການໃຊ້ບໍລິການ ຫຼື ຊອກຫາຕູ້ເອທີເອັມ ຂອງທະນາຄານຜູ້ອອກບັດເທົ່ານັ້ນ.',
  },
