...
@media (max-width: 600px) {
  ...
  /* ✅ Layout เหมือนกัน: bank-meta อยู่บน -> avatar -> name -> position */
  .person-card {
    flex-direction: column;
    align-items: center;
    text-align: center;
  ...
  /* ✅ ให้ order ทำงาน (เอา children ของ person-info มาเรียงกับ avatar-wrapper ได้) */
  .person-info {
    display: contents;
  }
